...
"**멈추지 않고 달리는 러너처럼**", 멈추지 않고 학습하며 발전하는 개발자입니다. <br />
탄탄한 기본기와 강한 책임감으로 안정적인 시스템을 구축합니다. <br />
...
> 삼성 헬스 CSV 데이터를 이용한 걷기, 달리기 데이터 분석
>
> - 1차 개발기간 : 2026.05.21 ~ 2026.05.28(7일) → 프로젝트 초안 완성
> - 2차 개발기간 : 2026.06.15 ~ 2026.06.17(3일) → 걷기 기능 추가
> - 핵심 역할 : 삼성 헬스에서 내보낸 CSV 파일을 분석하여 걷기와 달리기에 필요한 데이터로 가공하여 화면에 표시
>
>> Back-end
>> - Language : Java
